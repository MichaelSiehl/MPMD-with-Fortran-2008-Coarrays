...
SUBROUTINE OOOPinma_Start (Object)
  ...
  CALL OOOPimscS_atomic_intImageActivityFlag_CA (OOOPimscImageStatus_CA_1, OOOPimscEnum_ImageActivityFlag % InitialManager, & ! 160901
                                          THIS_IMAGE())
  !
  !*******
...
SUBROUTINE IIinma_ActivateTeamManagerImage (Object, intTeamManagerImageNumber, chrTeamMembersFileName)
  ...
  CALL OOOPimscS_atomic_intImageActivityFlag_CA (OOOPimscImageStatus_CA_1, OOOPimscEnum_ImageActivityFlag % TeamManager, & ! 160901
                                          intTeamManagerImageNumber)
  !
                                                                CALL OOOGglob_subResetProcedures
