...
SUBROUTINE IIimma_SYNC_CheckActivityFlag (Object)
  ...
  INTEGER(OOOGglob_kint) :: intImageActivityFlag2
  ...
  DO ! check the ActivityFlag of the OOOPimscImageStatus_CA standalone coarray wrapper
    ...
    CALL OOOPimscG_atomic_intImageActivityFlag_CA (OOOPimscImageStatus_CA_1, intImageActivityFlag, THIS_IMAGE()) ! 160829
