...
!                             _atomic_: setter/getter utilizing Fortran 2008 atomic subroutines
...
USE, INTRINSIC :: iso_fortran_env ! 160829
!___________________________________________________________
...
! access routines for scalar
! and static array members:
PUBLIC :: OOOPimscS_atomic_intImageActivityFlag_CA, OOOPimscG_atomic_intImageActivityFlag_CA, &
...
TYPE, PUBLIC :: OOOPimsc_DontUse1
  ...
  INTEGER(KIND=OOOGglob_kint) :: InitialManager ! = 4
...
TYPE, PUBLIC :: OOOPimsc_adtImageStatus_CA
  PRIVATE
  !*****
  INTEGER(atomic_int_kind) :: m_atomic_intImageActivityFlag = OOOPimscEnum_ImageActivityFlag % InitialWaiting ! 160829
  !*****
...
!
!**********
SUBROUTINE OOOPimscS_atomic_intImageActivityFlag_CA (Object_CA, intImageActivityFlag, & ! 160901
                                                   intImageNumber)
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                ...
                                                                !
  SYNC MEMORY ! 160829
  CALL ATOMIC_DEFINE(Object_CA[intImageNumber] % m_atomic_intImageActivityFlag, intImageActivityFlag) ! 160829
  !
                                                                CALL OOOGglob_subResetProcedures
END SUBROUTINE OOOPimscS_atomic_intImageActivityFlag_CA
!**********
SUBROUTINE OOOPimscG_atomic_intImageActivityFlag_CA (Object_CA, intImageActivityFlag, & ! 160901
                                                intImageNumber)
  TYPE (OOOPimsc_adtImageStatus_CA), CODIMENSION[*], INTENT (INOUT) :: Object_CA
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                CALL OOOGglob_subSetProcedures &
                                                                 ("OOOPimscG_atomic_intImageActivityFlag_CA")
                                                                ...
                                                                END IF
                                                                !
  CALL ATOMIC_REF(intImageActivityFlag, Object_CA[intImageNumber] % m_atomic_intImageActivityFlag) ! 160829
!
                                                                CALL OOOGglob_subResetProcedures
END SUBROUTINE OOOPimscG_atomic_intImageActivityFlag_CA
!**********
...
SUBROUTINE OOOPimscCopyImgToImg_intImageActivityFlag_CA (Object_CA, intImageNumberToCopyFrom, intImageNumberToCopyTo)
  ...
  INTEGER(OOOGglob_kint) :: Status = 0 ! error status
                                                                ...
                                                                !
  !
  Object_CA[intImageNumberToCopyTo] % m_atomic_intImageActivityFlag = &
                                  Object_CA[intImageNumberToCopyFrom] % m_atomic_intImageActivityFlag
  !
                                                                CALL OOOGglob_subResetProcedures
